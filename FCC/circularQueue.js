...
//The class itself should also accept an integer which you can 
//use to specify the size of the queue when you create it. 
//We've written the starting version of this class for you in the code editor. 
//When you enqueue items to the queue, the write pointer should advance 
//forward and loop back to the beginning once it reaches the end of the queue. 
...
//(our class won't let you overwrite data you haven't read yet) and 
//the read pointer should not be able to advance past data you have written.

//In addition, the enqueue method should return the 
//item you enqueued if it is successfully and otherwise return null. 
//Similarly, when you dequeue an item it should be returned and if you 
//cannot dequeue you should return null.
